...
class AllProductOfAllUser_ShowDetailPage extends StatefulWidget {
  const AllProductOfAllUser_ShowDetailPage({
    this.id,
    this.name,
    this.model,
    this.brand,
  ...
  final String userId;
  @override
  State<AllProductOfAllUser_ShowDetailPage> createState() => _AllProductOfAllUser_ShowDetailPageState();
}

class _AllProductOfAllUser_ShowDetailPageState extends State<AllProductOfAllUser_ShowDetailPage> {
  @override
